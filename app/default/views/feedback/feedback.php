                ...
                <form class="mx-1 mx-md-4" method="post">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                  	<div class="form-outline flex-fill mb-0">
                          ...
                          <option selected>Đánh giá số sao</option>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                  	<div class="form-outline flex-fill mb-0">
                        <textarea name="feed[cmt]" id="comment" feed[cmt] cols="30" rows="5" class="form-control" placeHolder="Bình luận sản phẩm" style="background-color: white;" required></textarea>
